"""
AI Agent for description generation following proper agent architecture patterns
"""
...
class DescriptionAgent:
    """
    AI Agent for generating video descriptions.
...
Please write a summary of the information provided explaining in simple terms what it means so it can be used as a description.  It is more of a step by step guide like an instruction manual but nice and simple to understand.

Try and take we we say literally, dont say we will help if we do not express specifically that we will.  It is okay to say it it in 10 words if 5 will do, it does not have to be short and conciise but rather easy to understand and literal.Your output should be clean, readable text ready for direct use.
"""
    
    def __init__(self, api_key: str, model: str = "gpt-4", temperature: float = 0.7, max_tokens: int = 1000):
        """
        Initialize the DescriptionAgent
